/*
  $Id: NodeFields.h,v 1.128 2013/02/11 21:45:59 dug9 Exp $
...
/* Proto node */
BEGIN_NODE(Proto)
EXPOSED_FIELD(Proto,children,mfnode,children,FIELDTYPE_MFNode)
...
FIELD(Proto,FreeWRL__protoDef,sfint32,FreeWRL__protoDef,FIELDTYPE_SFInt32)
