...
/*
  $Id: OpenGL_Utils.c,v 1.313 2013/01/04 13:56:37 crc_canada Exp $
...
\
    ...
    float specularAttenuation = 0.0; /* specular light - more pointed=brighter */ \n \
