...
$Id: fieldSet.h,v 1.17 2013/05/27 17:45:01 istakenv Exp $
...
void setField_javascriptEventOut_B(union anyVrml* any,int fieldType, unsigned len, int extraData, JSContext *scriptContext);
