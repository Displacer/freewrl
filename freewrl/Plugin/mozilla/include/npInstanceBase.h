...
/*
 * $Id: npInstanceBase.h,v 1.3 2005/03/21 13:39:14 crc_canada Exp $
 *
 * ***** BEGIN LICENSE BLOCK *****
...
// from mozilla plugin sdk - pluginbase.h

#ifndef _npInstanceBase_h_
#define _npInstanceBase_h_
...
#define STREAMBUFSIZE 0x0fffffff
...
public:
    ...
    virtual NPError NewStream(NPMIMEType type,
                              NPStream *stream,
                              NPBool seekable,
                              uint16 *stype) { return NPERR_NO_ERROR; }

    virtual NPError DestroyStream(NPStream *stream,
                                  NPError reason) { return NPERR_NO_ERROR; }
    ...
    virtual NPError GetValue(NPPVariable variable,
                             void *value) { return NPERR_NO_ERROR; }
...
/*
 * The following functions are called by Netscape Plugin API wrapper
 * functions (see npp_gate.cpp and npn_gate.cpp):
 */

// creation and destruction of the object of the derived class
npInstanceBase * NS_NewPluginInstance(npCreateData *aCreateDataStruct);
void NS_DestroyPluginInstance(npInstanceBase *aPlugin);

// global plugin initialization and shutdown
NPError NS_PluginInitialize();
void NS_PluginShutdown();

#endif // _npInstanceBase_h_
