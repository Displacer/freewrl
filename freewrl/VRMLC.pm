# $Id: VRMLC.pm,v 1.259 2007/01/22 18:44:51 crc_canada Exp $
#
...
sub gen {
	...
	push @genFuncs2, "/* convert an internal type to EAI type */\n". 
	...
	for(@VRML::Fields) {
		# print "node $_ is tagged as $fieldTypeCount\n";
		# tag each node type with a integer key.
		push @genFuncs2,  "\t\tcase FIELDTYPE_".$_.":	return EAI_$_;\n";
	}
	...
	for(@VRML::Fields) {
		# print "node $_ is tagged as $fieldTypeCount\n";
		# tag each node type with a integer key.
		push @genFuncs2,  "\t\tcase EAI_".$_.":	return FIELDTYPE_$_;\n";
	}
	push @genFuncs2, 	"	return -1;;\n}\n}\n";
	push @str, "int mapFieldTypeToEAItype (int st);\n";
