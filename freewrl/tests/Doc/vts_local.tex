%% $Id: vts_local.tex,v 1.5 2001/07/26 23:35:23 ayla Exp $
...
Material & \testCase \MatA & Passed \\\cline{2-3}
 ...
 & \MatNb & \\\cline{2-3}
 & \testCase \MatOa & Failed \\
 & \MatOb & \\\cline{2-3}
 & \testCase \MatPa & Passed \\
 & \MatPb & \\\cline{2-3}
 & \testCase \MatQa & Passed \\
 & \MatQb & \\\cline{2-3}
...
The background should be dark grey, but is rendered white.
...
The results are similar to section~\ref{sec:mat-emissive}.

\subsubsection{\MatAA}
The VRML file is specularcolor\_complex.wrl.\newline
The background, which should be dark grey not black, is too dark to see
the black geometries.
...
geometries over the range of transparency values.
See bug 444978.
...
%% The next subsubsection should be test case 7:
\subsubsection{\BkgGa \BkgGb}
The VRML file is verify-lastground.wrl.\newline
FreeWRL exits with a segmentation fault. See bug 444966.
