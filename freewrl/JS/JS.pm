...
#
# $Id: JS.pm,v 1.1.1.1.8.5 2002/08/30 21:10:52 ayla Exp $
#
#
#
...
sub sendevent {
	...
	unless($Types{$type}) {
		...
		&{"$type"."SetInternal"}($this->{JSContext}, $this->{JSGlobal}, "__evin", $value);
...
sub browserCreateVrmlFromString {
	...
	print "browserCreateVrmlFromString: string = \"$rs\"\n"
		if $VRML::verbose::js;
